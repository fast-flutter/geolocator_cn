...
class BMFCoordinateRegion implements BMFModel {
  ...
  BMFCoordinateRegion({
    ...
    required this.span,
        ...
        assert(span != null); // ignore: unnecessary_null_comparison
...
class BMFCoordinateBounds implements BMFModel {
  ...
  })  : assert(northeast != null), // ignore: unnecessary_null_comparison
        assert(southwest != null); // ignore: unnecessary_null_comparison
...
class BMFEdgeInsets implements BMFModel {
  ...
  BMFEdgeInsets.fromEdgeInsets(EdgeInsets insets)
      : assert(insets != null) // ignore: unnecessary_null_comparison
  {
    top = insets.top;
    left = insets.left;
